...
const PageContainer = styled.div`
  min-height: 100vh;
  background: linear-gradient(135deg, #f9fbff, #e6f3ff); /* subtle white-blue gradient */
  display: flex;
...
const TitleBar = styled.div`
  background: linear-gradient(90deg, #00a2ff, #4db8ff); /* sky blue gradient */
  color: #ffffff;
  font-size: 1.6rem;
  font-weight: 700;
  text-align: center;
...
const Input = styled.input`
  ...
  &:focus {
    ...
    background: #ffffff;
    outline: none;
    box-shadow: 0 0 4px rgba(0, 162, 255, 0.2);
  }
`;
